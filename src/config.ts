...
export const themeConfig: ThemeConfig = {
  // SITE INFO ///////////////////////////////////////////////////////////////////////////////////////////
  site: {
    website: 'https://kthread.dev', // Site domain
    title: 'kptr', // Site title
    author: 'kptr', // Author name
    description: 'I have a vested interest in making my own life hard when it comes to coding, computers, and technology overall.', // Site description
